# MekanismDelight
![](https://github.com/Mochi-753/MekanismDelight/blob/main/docs/Logo.png)

**MekanismDelight** is a small mod that adds cooperative elements between Farmer's Delight and Mekanism.  
[GitHub](https://github.com/mochi-753/MekanismDelight)

## Features

**MekanismDelight** works simply by installing it.  
...
<details>
<summary>Detailed integration features per Mekanism module</summary>
<br>
...
It includes code and assets from Mekanism and Farmer’s Delight.  
These mods are also provided under the MIT License, and the full license texts can be found in the LICENSES directory.  
Finally, we would like to express our sincere gratitude to the developers of these excellent mods.  